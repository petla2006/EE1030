...
\begin{multicols}{2}
\item $\brak{a}$ $-1$, $i+2\omega$,$1+2\omega^2$
\item $\brak{b}$ $-1$ ,$1-2\omega$ ,$1-2\omega^2$
\item $\brak{c}$ $ -1 , -1 ,-1 $ 
\item $\brac{d}$ None of these
\end{multicols}
...
\item $\brak{b}$ $n=16$
\item $\brak{c}$ $n=12$
\item $\brak{d}$ None of these
\end{multicols}
 3. The complex number $z= x+iy$ which satisfy the equation \hfill\brak{1981 - 2 Marks}
     $\abs{\frac{z-5i}{z+5i}} = 1 $lie on 
\begin{multicols}{2}
\item $\brak{a}$ the x-axis
\item $\brak{b}$ the straight line $y=5$
\item $\brak{c}$ a circle passing through the origin 
\item $\brak{d}$ None of these
 \end{multicols}
 4. If $z=(\frac{\sqrt{3}}{2} + \frac{i}{2})^5$ + $\brak{\frac{\sqrt{3}}{2} - \frac{i}{2}}^5$ , then \hfill{\brak{1982 - 2 Marks}
\begin{multicols}{2}
\item $\brak{a} Re\brak{z}=0$
\item $\brak{b} Im\brak{z}=0$
\item $\brak{c} Re\brak{z}>0, Im\brak{z}>0$
\item $\brak{d} Re\brak{z}>0, Im\brak{z}<0$
\end{multicols}
 5. The inequality $\abs{z-4}<\abs{z-2}$ represents the region given by \hfill\brak{1982 - 2 Marks}
\begin{multicols}{1}
\item $\brak{a} Re\brak{z}\ge0$
\item $\brak{b} Re\brak{z}<0$ 
\item $\brak{c} Re\brak{z}>0$ 
\item $\brak{d} None of these
\end{multicols}

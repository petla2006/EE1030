...
\draw (3,8.25) to[short] (3,5.75);
\draw (3,8.25) to[R] (5.25,8.25);
\draw (3,5.75) to[R] (5.75,5.75);
\draw (5.75,5.75) to[R] (9,5.75);
\draw (9,5.75) to[short] (9,8.25);
\draw (6.5,8.25) to[R] (9,8.25);
\draw (5.25,8.25) to[short] (5.25,7.75);
\draw (6.5,8.25) to[short] (6.5,7.75);
\draw (5,7.75) to[short] (6.75,7.75);
\draw [->, >=Stealth] (6,5.75) -- (6,7.75);
\draw  (6,7.5) ellipse (1cm and 1cm);
\draw (9,5.75) to (9,5.25) node[ground]{};
\draw (3,8.25) to[short, -o] (3,9) ;
\node [font=\normalsize] at (4,7.75) {2 k$\Omega$};
\draw (5,8.25) to[short, -o] (5,9) ;
\node [font=\normalsize] at (7.75,7.75) {4 k$\Omega$};
\node [font=\normalsize] at (7.25,5.25) {42 k$\Omega$};
\node [font=\normalsize] at (2.75,9.25) {$V_{DD}$ = 16 V};
\node [font=\normalsize] at (5.25,9) {P};
\node [font=\normalsize] at (4.25,5.25) {R};
\end{circuitikz}
}%
\label{fig:my_label}
\end{figure}
